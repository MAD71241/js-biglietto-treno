...
if (passengerAge < 18) {
    ...
    console.log(discountedMessage + (totalPrice - percentage(totalPrice, 20)).toFixed(2) + " euro.");
}
//va applicato uno sconto del 40% per gli over 65. 
    ...
    console.log(discountedMessage + (totalPrice - percentage(totalPrice, 40)).toFixed(2) + " euro.");
} else {
    console.log(message + totalPrice + " euro.");
}
